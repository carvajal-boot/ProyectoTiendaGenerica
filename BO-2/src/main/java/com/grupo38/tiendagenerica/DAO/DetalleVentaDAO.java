...
public class DetalleVentaDAO {
	...
	public void registrarDetalleVenta(Detalle_ventasVO detalleventa) {
		...
		try {
			...
			String sentencia = "INSERT INTO detalle_ventas VALUES(" + detalleventa.getCodigo_detalle_venta() + ","
					+ detalleventa.getCantidad_producto() + "," + detalleventa.getCodigo_productos() + ","
					+ detalleventa.getCodigo_venta() + "," + detalleventa.getValor_total() + ","
					+ detalleventa.getValor_venta() + "," + detalleventa.getValor_iva() + "" + ");";
	...
	public ArrayList<Detalle_ventasVO> listaDeDetalleVenta() {
		// lista que contendra el o los usuarios obtenidos
		ArrayList<Detalle_ventasVO> listadetalle_ventas = new ArrayList<Detalle_ventasVO>();
		...
		try {
			...
			while (res.next()) {
				Detalle_ventasVO venta = new Detalle_ventasVO();
				...
				venta.setCodigo_productos(Integer.parseInt(res.getString("codigo_productos")));
	...
	public void actualizarDetalleVenta(Detalle_ventasVO detalleventa) {
