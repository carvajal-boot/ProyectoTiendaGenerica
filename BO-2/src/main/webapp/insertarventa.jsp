	...
	<div id="layoutSidenav_content">
		<main>
			...
			<div
				...
				<center>
					<h1 class="mt-4">Modulo Ventas</h1>
				</center>
				...
				<div class="col-xl-12 col-lg-12 col-md-12">
					<div class="card mb-4">
						...
						<div class="card-body">
							<center>
								<h1>
									<i class="fas fa-cart-arrow-down"></i> Factura de Ventas
								</h1>
							</center>
							...
							<form>
								...
								<div class="row ">
									...
									<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
										<div class="input-group input-group-sm mb-3">
											...
											<form>
												<input type="text" value="0" class="form-control" id="cant1"
								...
								<div class="row ">
									...
									<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Cant.</span>
											<input type="text" value="0"  class="form-control" id="cant2"
								...
								<div class="row ">
									...
									<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Cant.</span>
											<input type="text" value="0"  class="form-control" id="cant3"
								...
								<div class="row ">
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
										<button type="button" class="btn btn-success"
											onclick="registrar()">
											<i class="fas fa-plus-circle"></i> Guardar Venta
										</button>
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
	...
	<script>
		...
		function registrar() {
			try {
				...
				formData.append("iva_venta", document
